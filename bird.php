...
<section class="bird-hero">
    ...
    <div class="bird-hero-content">
        ...
        <div class="bird-text">
            ...
            <p>
                Everything your birds need in one place
            </p>
    ...
    <a href="Bird-Accessories.php"
       class="bird-card">
        ...
        <div class="bird-card-image">
            ...
            <img src="imgs/bird accessories feeder.png"
                 alt="Accessories">
    ...
    <a href="bird-perches.php"
       class="bird-card">
        ...
        <div class="bird-card-image">
            ...
            <img src="imgs/bird swing animated.png"
                 alt="Perches">
