...
<h1 class="page-title">Dog Beds</h1>

<section class="section" id="dog-beds">
    <h2>Dog Beds</h2>
    <div class="products">

        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Round Plush Pet Bed.jfif" alt="Round Plush Pet Bed">
            </div>
            <h3>Round Plush Dog Bed</h3>
            <p class="price">₪20</p>
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Corduroy Dog Sofa Bed.jfif" alt="Corduroy Dog Sofa Bed">
            </div>
            <h3>Corduroy Dog Sofa Bed</h3>
            <p class="price">₪25</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Soft Rectangular Pet Bed.jfif" alt="Soft Rectangular Pet Bed">
            </div>
            <h3>Soft Rectangular Pet Bed</h3>
            <p class="price">₪20</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Checkered Washable Dog Bed.jfif" alt="Checkered Washable Dog Bed">
            </div>
            <h3>Checkered Washable Dog Bed</h3>
            <p class="price">₪25</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Washable Dog Pillow Bed.jfif" alt="Washable Dog Pillow Bed">
            </div>
            <h3>Washable Dog Pillow Bed</h3>
            <p class="price">₪30</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Cocoon Dog Bed.jfif" alt="Cocoon Dog Bed">
            </div>
            <h3>Cocoon Dog Bed</h3>
            <p class="price">₪35</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
...
<section class="section" id="dog-carriers">
    <h2>Dog Carriers & Bags</h2>
    <div class="products">

        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Plastic Pet Travel Carrier.jfif" alt="Plastic Pet Travel Carrier">
            </div>
            <h3>Plastic Dog Travel Carrier</h3>
            <p class="price">₪35</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Pet Travel Carrier Cage.jpeg" alt="Pet Travel Carrier Cage">
            </div>
            <h3>Pet Travel Carrier Cage</h3>
            <p class="price">₪30</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Pet Backpack Carrier.jfif" alt="Pet Backpack Carrier">
            </div>
            <h3>Dog Backpack Carrier</h3>
            <p class="price">₪45</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
        ...
        <div class="product-card">
            <div class="img-box">
                <img src="imgs/Soft Mesh Pet Carrier Bag.jfif" alt="Soft Mesh Pet Carrier Bag">
            </div>
            <h3>Soft Mesh Pet Carrier Bag</h3>
            <p class="price">₪55</p>
            <div class="quantity">
                <label>Quantity</label>
                <input type="number" value="1" min="1">
